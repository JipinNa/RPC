...
func (x *StreamRspData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamRspData) ProtoMessage() {}

func (x *StreamRspData) ProtoReflect() protoreflect.Message {
	mi := &file_stream_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamRspData.ProtoReflect.Descriptor instead.
func (*StreamRspData) Descriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{1}
}

func (x *StreamRspData) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_stream_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x73, 0x70,
	...
	0x61, 0x1a, 0x0e, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x73, 0x70, 0x44, 0x61, 0x74,
	...
	0x1a, 0x0e, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x73, 0x70, 0x44, 0x61, 0x74, 0x61,
	...
	0x0e, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x73, 0x70, 0x44, 0x61, 0x74, 0x61, 0x28,
...
var file_stream_proto_goTypes = []interface{}{
	...
	(*StreamRspData)(nil), // 1: StreamRspData
}
var file_stream_proto_depIdxs = []int32{
	...
	1, // 3: Greeter.GetStream:output_type -> StreamRspData
	1, // 4: Greeter.PutStream:output_type -> StreamRspData
	1, // 5: Greeter.AllStream:output_type -> StreamRspData
...
func (x *greeterGetStreamClient) Recv() (*StreamRspData, error) {
	m := new(StreamRspData)
...
func (x *greeterPutStreamClient) CloseAndRecv() (*StreamRspData, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(StreamRspData)
...
func (x *greeterAllStreamClient) Recv() (*StreamRspData, error) {
	m := new(StreamRspData)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *greeterGetStreamServer) Send(m *StreamRspData) error {
...
func (x *greeterPutStreamServer) SendAndClose(m *StreamRspData) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *greeterAllStreamServer) Send(m *StreamRspData) error {
	return x.ServerStream.SendMsg(m)
}
